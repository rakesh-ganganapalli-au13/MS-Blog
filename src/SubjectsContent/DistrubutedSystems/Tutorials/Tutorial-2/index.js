...
const cryptography = [
  [textVarient.h5, "Cryptography", { textAlign: "center", margin: "1%" }],
  [textVarient.bold, "Cryptography", span],
  [
    textVarient.body1,
    `is the practice and study of techniques for
    securing communication and data in the presence of adversaries.`,
    { span: true },
  ],
  ["br"],
  [textVarient.bold, "Crypt", span],
  [textVarient.body1, "meanes hidden or vault and", span],
  [textVarient.bold, "graphy", span],
  [textVarient.body1, " meanes write or study", span],
  [
    textVarient.image,
    {
      src: distributedSystems["tutorial-2"].image1,
      alt: "example",
      style: {
        textAlign: "center",
        width: "50vw",
